...
class jobRecyclerViewHolder(private val binding: ItemTrabajitoCardViewBinding, val context: Context): RecyclerView.ViewHolder(binding.root) {

    @RequiresApi(Build.VERSION_CODES.O)
    fun bind(trabajito: tempJobModel, clickListener: (tempJobModel) -> Unit){
        binding.workerNameItem.text = trabajito.id_solicitor.name
