...
val porfolios = mutableListOf(
    PortfolioModel(
        ...
        title = "",
        description = "hola",
        images =  "https://phantom-marca.unidadeditorial.es/936fd16b77c008bf1039febccb975c52/resize/828/f/jpg/assets/multimedia/imagenes/2023/05/09/16836175499566.jpg",
        user = "Lee ",
        category = "Futbolista",
        review = listOf(
